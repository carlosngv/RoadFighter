...
tab3 db 9,9,9,'$'
tab4 db 9,9,9,9,'$'
menuinicial db 10,13,'====== ROAD FIGHTER ======',10,13,'1. Juego',10,13,'2. Registro',10,13,'3. Salir','$'
escoja db 10,13,'Elija una opcion: ','$'
encabezado db 10,13,'UNIVERSIDAD DE SAN CARLOS DE GUATEMALA',13,10,'FACULTAD DE INGENIERIA',13,10,'CIENCIAS Y SISTEMAS',13,10,'ARQUITECTURA DE COMPUTADORES Y ENSAMBLADORES 1',13,10,'CARLOS NG',13,10,'201801434',10,13,'VACACIONES 2S2020','$'
menuUser db 10,13,10,13,'1) Iniciar',10,13,'2) Cargar Juego',10,13,'3) Salir de usuario','$'
menuAdmin db 10,13,10,13,'1) Top 10 puntos',10,13,'2) Top 10 tiempo',10,13,'3) Salir','$'
msjRegUser db 'Nombre de usuario: ','$' ;registrar usuario
msjRegContra db 'Clave (4 digitos): ','$'	;registrar contraseña
msjU db 'Usuario: ','$'
msjC db 'Clave: ','$'
entradaU db 7 dup('$'),'$'
entradaC db 4 dup('$'),'$'	
...
rutapuntos db 'P2/Puntos.rep',00h
...
rutatiempos db 'P2/Tiempos.rep',00h
...
msjMenuOrden db 9,9,'ORDENAMIENTOS',10,13,'1) BubbleSort',10,13,'2) QuickSort',10,13,'3) Ordenamiento ShellSort',10,13,'4) Regresar','$'
msjvelocidad db 10,13,'INGRESE UNA VELOCIDAD (0-9): ','$'
msjASDEC db 10,13,'Tipo:',10,13,'1) Descendente',10,13,'2) Ascendente','$'
;Memoria del menu
