...
leerCadena macro buffer
	LOCAL ObtenerChar, FinOT ;LOCAL sirve que a la hora de llamar varias veces el metodo ObtenerTexto no haya ucion para el compilador con las etiquetas al hacer los saltos condicionales
